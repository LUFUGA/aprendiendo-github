...
(
 ...
 WHERE (PER_ESTADO_PERSONA = 1 OR PER_ESTADO_PERSONA_RPH = 1)
		OR
		((PER_ESTADO_PERSONA_RPH IS NULL OR PER_ESTADO_PERSONA_RPH = 0) AND COL.dato_col6=3 AND per.sexo is not null and per.edad is not null)
